			...
			<div  style="align:center; margin-left: 100px; margin-top: 40px; ">
				...
				<table align="center" cellpadding="10" width="500" style="border-collapse:collapse;">
					...
					<tr>
						...
						<td ><input type="text" size="5" id="age" name="age" value="${memberInfo.age }">　세</td>
					</tr>
					<tr>
						<th align="center"> 키</th>
						<td ><input type="text" size="5" id="height" name="height">　cm</td>
					</tr>
					<tr>
						<th align="center">몸무게</th>
						<td ><input type="text" size="5" id="weight" name="weight">　kg</td>
					</tr>
					<tr>
						<th align="center">목표체중</th>
						<td ><input type="text" size="5" id="goal" name="goal">　kg</td>
					</tr>
					<tr>
						<th align="center">체중감량기간</th>
						<td ><input type="text" size="5" id="period" name="period">　개월</td>
					</tr>
					<tr>
